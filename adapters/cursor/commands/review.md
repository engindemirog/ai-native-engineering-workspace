...
INDEPENDENCE: this command must run in a FRESH chat that has never seen the builder's conversation. Read only the diff, the spec, the plan, and docs/. Do not modify any file.

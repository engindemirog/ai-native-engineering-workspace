...
1) Compare the current change set against specs/plans/<NNNN>-plan.md; produce a DEVIATION LIST
   (file + why).
2) For each deviation: was it necessary? If yes, propose it as a plan amendment — I approve and you
   record it under "Approved deviations" in the plan. If no, REVERT that change.
